...
{
    internal static class MetalinkLoader
    {
        public static Stream? LoadMetalinkStream(string resource)
        {
            string fullName = $"Metalinker.Tests.Resources.{resource}";
            return typeof(MetalinkLoader).Assembly.GetManifestResourceStream(fullName);
        }
    }
}
