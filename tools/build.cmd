...
"%ProgramFiles%\dotnet\dotnet.exe" restore "%ROOTDIR%\Metalinker.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
:build
echo Building...
"%ProgramFiles%\dotnet\dotnet.exe" build "%ROOTDIR%\Metalinker.sln" -p:Configuration=%releaseconfig% %buildoptions%
